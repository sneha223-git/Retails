...
package local_project.demotalend_job_0_1;
...
/**
 * Job: demotalend_job Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class demotalend_job implements TalendJob {
...
public String getOutputfile_path(){
	...
	private final String jobName = "demotalend_job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				demotalend_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(demotalend_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_demotalend_job = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_demotalend_job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_demotalend_job.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_demotalend_job.length == 0) {
   					commonByteArray_LOCAL_PROJECT_demotalend_job = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_demotalend_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_demotalend_job, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_demotalend_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_demotalend_job) {
 ...
 */
	...
	currentComponent="Implicit_Context_Regex";
        ...
        Object source_Implicit_Context_Regex = /** Start field Implicit_Context_Regex:FILENAME */"/home/ec2-user/Talend/demotalend_job_0.1/config/"/** End field Implicit_Context_Regex:FILENAME */;
        ...
        if(source_Implicit_Context_Regex instanceof String || source_Implicit_Context_Regex instanceof java.io.InputStream){
        	inImplicit_Context_Regex = new org.talend.fileprocess.TOSDelimitedReader(/** Start field Implicit_Context_Regex:FILENAME */"/home/ec2-user/Talend/demotalend_job_0.1/config/"/** End field Implicit_Context_Regex:FILENAME */, "ISO-8859-15", "", "\n", removeEmptyRowImplicit_Context_Regex);
        }else{
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("name");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("name2");
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:BdCwyGgejD/xPaRz5R7TmgAJoQUVWiem5u1g7A==");
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "name2";

				row1.name2 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.name2 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
 ...
 */
    ...
    public static void main(String[] args){
        final demotalend_job demotalend_jobClass = new demotalend_job();

        int exitCode = demotalend_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = demotalend_job.class.getClassLoader().getResourceAsStream("local_project/demotalend_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = demotalend_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : demotalend_job");
        }
...
/************************************************************************************************
 *     72536 characters generated by Talend Open Studio for Data Integration 
 *     on the March 8, 2021 1:22:01 AM CST
 ************************************************************************************************/